...
parser.add_argument('--net_cache', type=str, default='/content/drive/MyDrive/Research_RL_RA_MNIST/MetaPruning-master/mobilenetv1/searching/checkpoint.pth.tar', help='model to be loaded')
...
# load training data
args.data = "/content/drive/MyDrive/Research_RL_RA_MNIST/MNIST"  # The parent directory
